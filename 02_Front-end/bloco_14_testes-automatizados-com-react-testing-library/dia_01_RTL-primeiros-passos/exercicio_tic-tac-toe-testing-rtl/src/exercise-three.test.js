...
winnerSymbols.forEach((winnerSymbol) => {
  describe(`Condições de vitória para o Jogador ${winnerSymbol}`, () => {
    ...
    firstCellsOfLines.forEach((cellId) => {
      it(`Alcançar a vitória ao colocar o mesmo simbolo em todas as casas da linha a partir da casa ${cellId}`, () => {
    ...
    firstCellsOfColumns.forEach((cellId) => {
      it(`Alcançar a vitória ao colocar o mesmo simbolo em todas as casas da coluna ${cellId}`, () => {
    ...
    it('Alcançar a vitória ao colocar o mesmo simbolo na diagonal esquerda para direita (primeira,quinta,nona casa)', () => {
      render(<App />);
    ...
    it('Alcançar a vitória ao colocar o mesmo simbolo na diagonal direita para esquerda (terceira,quinta,sétima casa)', () => {
      render(<App />);
  ...
  describe('bonus', () => {
    ...
    it('Reiniciar um jogo em empate', () => {
      render(<App />);
      userEvent.click(screen.getByTestId('cell_0'));
      userEvent.click(screen.getByTestId('cell_1'));
      userEvent.click(screen.getByTestId('cell_2'));
    ...
    it('Reiniciar um jogo no meio da partida', () => {
      render(<App />);
      userEvent.click(screen.getByTestId('cell_0'));
      userEvent.click(screen.getByTestId('cell_1'));
      userEvent.click(screen.getByTestId('cell_2'));
    ...
    it('Reiniciar um jogo ganho pelo jogador X', () => {
      render(<App />);
      userEvent.click(screen.getByTestId('cell_0'));
      userEvent.click(screen.getByTestId('cell_3'));
      userEvent.click(screen.getByTestId('cell_1'));
    ...
    it('Reiniciar um jogo ganho pelo jogador O', () => {
      render(<App />);
      userEvent.click(screen.getByTestId('cell_3'));
      userEvent.click(screen.getByTestId('cell_0'));
      userEvent.click(screen.getByTestId('cell_4'));
